...
namespace WiteemFramework.Handle
{
    public abstract class SQLHelper
    {
        ...
        public abstract bool ExecuteTransaction(List<string> sqlList);
        ...
        /// <returns></returns>
        protected virtual bool ExecTransaction(List<string> sqlList)
        {
            ...
            try
            {
                ...
                {
                    cmd = ExecCmd(item, CommandType.Text, null);
